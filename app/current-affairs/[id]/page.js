          ...
          <div className="glass-card">
            ...
            {mism.length === 0 ? (
              ...
              <div className="mt-16" style={{ display: "grid", gap: 14 }}>
                {mism.map((r) => (
                  <div key={r.i} className="answer-box" style={{ borderColor: r.confidence === "high" ? "rgba(52,211,153,0.4)" : "rgba(251,191,36,0.4)" }}>
                        ...
                        {q.options.map((opt, oi) => {
                          ...
                          return (
                            <div key={oi} style={{
                              ...
                              border: "1px solid " + (isAns ? "rgba(52,211,153,0.6)" : "var(--glass-border)"),
                              background: isAns ? "rgba(52,211,153,0.12)" : "rgba(0,0,0,0.2)",
                            }}>
