...
const SUBS = [
  ...
  { icon: "🎯", name: "Error Pro", count: "1,642", desc: "Aman Sir — 13 chapters, error-spotting practice.", href: "/pyq/errorpro" },
    ...
    <>
      <section className="hero" style={{ paddingBottom: 8 }}>
        ...
        <p className="hero__sub">
          <b>29,670</b> ready-made questions — chapter-wise, poore solution ke saath. Kuch upload nahi karna.
