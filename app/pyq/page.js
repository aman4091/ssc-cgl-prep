...
const SUBS = [
  ...
  { icon: "🎯", name: "Error Pro", count: "2,660", desc: "Aman Sir — 18 chapters, error-spotting practice.", href: "/pyq/errorpro" },
    ...
    <>
      <section className="hero" style={{ paddingBottom: 8 }}>
        ...
        <p className="hero__sub">
          <b>30,688</b> ready-made questions — chapter-wise, poore solution ke saath. Kuch upload nahi karna.
