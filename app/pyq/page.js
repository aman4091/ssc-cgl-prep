...
const SUBS = [
  ...
  { icon: "🎯", name: "Error Pro", count: "2,431", desc: "Aman Sir — 17 chapters, error-spotting practice.", href: "/pyq/errorpro" },
    ...
    <>
      <section className="hero" style={{ paddingBottom: 8 }}>
        ...
        <p className="hero__sub">
          <b>30,459</b> ready-made questions — chapter-wise, poore solution ke saath. Kuch upload nahi karna.
