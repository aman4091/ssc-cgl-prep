...
const SUBS = [
  ...
  { icon: "🎯", name: "Error Pro", count: "1,492", desc: "Aman Sir — 12 chapters, error-spotting practice.", href: "/pyq/errorpro" },
    ...
    <>
      <section className="hero" style={{ paddingBottom: 8 }}>
        ...
        <p className="hero__sub">
          <b>29,520</b> ready-made questions — chapter-wise, poore solution ke saath. Kuch upload nahi karna.
