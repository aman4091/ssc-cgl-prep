...
export function addFact({ sec, topic, text }) {
  ...
  const f = {
    ...
    // Ek fact ab kai line ka ho sakta hai (overlay ke 📝 one-liner ka poora
    // set: numbered lines + "🧠 Yaad rakhne ki trick") — 600 mein wo kat jata
    // tha, aur trick hi gayab ho jati thi.
    text: t.slice(0, 1500),
    day: dayKey(),
