...
// Speed page ke 6 time-brackets ko ek subject ke menu-rows mein badalta hai.
function speedBracketLinks(subject) {
  return [
    { key: "b1", label: "Under 30 sec" },
    { key: "b2", label: "30 – 50 sec" },
    { key: "b3", label: "50 sec – 1:10" },
    { key: "b4", label: "1:10 – 1:30" },
    { key: "b5", label: "1:30 – 2:00" },
    { key: "over2", label: "Over 2 min · skip/galat" },
  ].map((b) => ({ href: `/speed?subject=${subject}&bucket=${b.key}`, label: b.label }));
}
...
export const NAV_GROUPS = [
  ...
  {
    // Speed -> Maths/Reasoning -> time-bracket -> us bracket ke questions (/speed).
    key: "speed",
    name: "Speed · Time",
    icon: "⏱️",
    children: [
      { key: "speed-math", name: "Maths", icon: "🧮", links: speedBracketLinks("math") },
      { key: "speed-reason", name: "Reasoning", icon: "🧠", links: speedBracketLinks("reasoning") },
    ],
  },
  {
    key: "notes",
  ...
  },
  {
    ...
    // marks the shelf /wrong opens on when there is no query.
    links: [
      { href: "/wrong?subject=reasoning", label: "🧠 Reasoning", isDefault: true },
      { href: "/wrong?subject=gs", label: "🌍 GS" },
      { href: "/wrong?subject=math", label: "🧮 Maths" },
      { href: "/wrong?subject=english", label: "📘 English" },
    ],
  },
];
...
export const NAV_DIRECT = [
  { href: "/today", label: "40-Day Plan", icon: "📅" },
