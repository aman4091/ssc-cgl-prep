...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    links: [
      { href: "/pyq/war", label: "WAR · 3,152" },
      { href: "/pyq/pinnacle", label: "Pinnacle English · 7,585" },
      { href: "/pyq/mathbank", label: "Pinnacle Maths · 6,420" },
      { href: "/pyq/reasonbank", label: "Pinnacle Reasoning · 3,543" },
      { href: "/pyq/gktricks", label: "GKTricks · 1,677" },
      { href: "/pyq/mirror", label: "Mirror of Common Errors · 51" },
    ],
  },
  {
    key: "notes",
