...
// Jawab badla — sprint ka parda bina reload ke naya jawab dikha de.
function pingAns(q, text) {
  if (typeof window === "undefined") return;
  try { window.dispatchEvent(new CustomEvent("cgl:sprint-ans", { detail: { h: sHash(q), text } })); }
  catch { /* ignore */ }
}
