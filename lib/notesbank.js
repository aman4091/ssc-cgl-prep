...
const BOOKS = {
  ...
  "parmar-polity": {
    ...
    scanBase: `${R2}/parmar-polity`,
    subject: "gs",
    eyebrow: "🏛️ Polity Notes",
    title: "Polity — Parmar GK/GS",
    sub:
      "Parmar SSC GK/GS Theory Book ka Polity section — 19 chapters, Making of the " +
      "Constitution se Noteworthy Points tak. Mind-map figures book se; har page ke " +
      "neeche asli scan hai, wahi source of truth hai.",
    note:
      "Parmar SSC ka copyrighted theory book, apni study ke liye transcribe kiya. Text " +
      "machine-transcription hai — jo ajeeb lage, page ka scan kholo.",
  },
  "eng-formula": {
