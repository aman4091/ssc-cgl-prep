...
function blocksFor(day, m) {
  ...
  const calc = B("calc", 15, "maths", "Calc drill: tables 12–25, squares 1–30, fraction ↔ %", {
    must: true, nm: "🧮 Calc drill", tg: "20 random · bol ke", href: "/calculation", hrefLabel: "🧮 Calc",
  });
...
function taperBlocks(p, day, m) {
  const calc = B("calc", 15, "maths", "Calc drill (haath garam)", { must: true, nm: "🧮 Calc drill", tg: "15 min", href: "/calculation", hrefLabel: "🧮 Calc" });
