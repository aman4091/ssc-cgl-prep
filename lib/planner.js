...
const QA_UNITS = {
  ...
  simp: { name: "Simplification", tip: "Squares 1-30, cubes 1-15 yaad. Options pehle dekho — approx se 10 sec mein answer.",
          links: [brah("Simplification"), m25("simplification-and-approximation")] },
...
// Per-unit, PER-PASS question pools — spec ka teesra element WAR bank ke
// chapter tags hain, taaki jis din jo chapters padhne hain usi din ke
// questions milein (GKTricks mein tags nahi, isliye woh sirf mixed passes mein).
const GA_PASS_AUTO = [
  [ // Polity — Constitution basics
    [["war", "polity", ["Fundamental Rights", "Salient Features"]]],
    [["war", "polity", ["Preamble", "Making Of Constitution", "Sources of Constitution & Misl"]]],
    [["war", "polity", ["DPSP & Fundamental Duties", "Union territory & Citizenship", "Salient Features"]]],
    [["war", "polity", ["Important Acts & New Laws"]]],
    [["war", "polity", ["Fundamental Rights", "Salient Features"]], ["gk", "polity"]],
  ],
  [ // Polity — Parliament, President, Courts
    [["war", "polity", ["Parliament", "Supreme & High Court"]]],
    [["war", "polity", ["President & VP", "PM & Council of Ministers"]]],
    [["war", "polity", ["State Legislature", "Local government"]]],
    [["war", "polity", ["Emergency & Amendments", "Const & non Const Bodies"]]],
    [["war", "polity", ["Parliament", "Important Acts & New Laws"]], ["gk", "polity"]],
  ],
  [ // Ancient
    [["war", "ancient-history", ["Buddhism & Jainism", "Prehistoric & IVC"]], ["gk", "ancient-history"]],
    [["war", "ancient-history", ["Vedic Culture", "Mahajanapadas"]], ["gk", "ancient-history"]],
    [["war", "ancient-history", ["Gupta Empire", "Mahajanapadas"]], ["gk", "ancient-history"]],
    [["war", "ancient-history", ["Sangam Age", "Miscellaneous"]], ["gk", "ancient-history"]],
    [["war", "ancient-history", ["Gupta Empire", "Miscellaneous"]], ["gk", "ancient-history"]],
  ],
  [ // Medieval
    [["war", "mediaeval-history", ["Delhi Sultanate", "Mughal Empire & Sur Dynasty"]]],
    [["war", "mediaeval-history", ["Vijay Nagar & Bahamani", "Maratha Empire"]]],
    [["war", "mediaeval-history", ["Bhakti & Sufi Movements", "Sikhism"]]],
    [["war", "mediaeval-history", ["Early mediaeval and regional kingdom", "Miscellaneous"]]],
    [["war", "mediaeval-history", ["Delhi Sultanate", "Vijay Nagar & Bahamani"]]],
  ],
  [ // Modern
    [["war", "modern-history", ["Freedom struggle", "Revolt Of 1857"]]],
    [["war", "modern-history", ["Advent of Europeans", "Freedom struggle"]]],
    [["war", "modern-history", ["Social & Religious Reforms", "British Administration", "British Adminstration"]]],
    [["war", "modern-history", ["Freedom struggle", "Tribal and Peasant movement"]]],
    [["war", "modern-history", ["Post Independence Era", "British Administration", "Miscellaneous"]]],
  ],
  [ // Geography — India
    [["war", "geography", ["Peninsular Rivers", "Soil & Agriculture"]]],
    [["war", "geography", ["Himalayas", "India & its Location", "Peninsular Rivers"]]],
    [["war", "geography", ["Soil & Agriculture", "Minerals"]]],
    [["war", "geography", ["MONSOON", "PENINSULAR PLATEAUS", "ATMOSPHERE"]]],
    [["war", "geography", ["Northern Plains & Islands", "Dams, Lakes & Waterfalls", "Demographics"]]],
  ],
  [ // Geography — World + Environment
    [["war", "environment", ["Basics"]], ["war", "geography", ["World Map", "Solar system", "SOLAR SYSTEM"]]],
    [["war", "environment", ["Basics", "Biodiversity & Conservation"]]],
    [["war", "environment", ["Biodiversity & Conservation"]], ["war", "geography", ["National Parks"]]],
    [["war", "environment", ["Govt. SCHEMES & Initiatives"]], ["war", "geography", ["Earth's Interior And Plate Tectonic", "ROCKS, CONTINENTS & OCEANS"]]],
    [["war", "environment", ["Basics", "Govt. SCHEMES & Initiatives"]], ["war", "geography", ["Wind oceanic current & Cyclones", "ATMOSPHERE"]]],
  ],
  [ // Economy — Basics, Banking
    [["war", "economics", ["Basics of Economy", "Money & Banking"]]],
    [["war", "economics", ["National Income", "Monetary Policies"]]],
    [["war", "economics", ["Money & Banking", "Demand & Supply"]]],
    [["war", "economics", ["Basics of Economy", "Monetary Policies"]]],
    [["war", "economics", ["Money & Banking", "National Income"]]],
  ],
  [ // Economy — Budget, Plans, Reports
    [["war", "economics", ["Budget & Taxation", "Five Year Plan & Indust Policy"]]],
    [["war", "economics", ["Inflation & Unemployment", "BOP, Poverty & Int Trade"]]],
    [["war", "economics", ["Budget & Taxation", "BOP, Poverty & Int Trade"]]],
    [["war", "economics", ["Five Year Plan & Indust Policy", "Inflation & Unemployment"]]],
    [["war", "economics", ["BOP, Poverty & Int Trade", "MISCELLANEOUS"]]],
  ],
  [ // Physics
    [["war", "physics", ["Motion", "Human Eye Vision & Electricity"]]],
    [["war", "physics", ["Force & Laws of Motion", "Human Eye Vision & Electricity"]]],
    [["war", "physics", ["Gravitation Work Energy Power", "Sound"]]],
    [["war", "physics", ["Reflection and Refrection", "Miscellaneous"]]],
    [["war", "physics", ["Motion", "Human Eye Vision & Electricity", "Miscellaneous"]]],
  ],
  [ // Chemistry — sirf 29 Q hain, filter ka fayda nahi
    [["war", "chemistry"]], [["war", "chemistry"]], [["war", "chemistry"]], [["war", "chemistry"]], [["war", "chemistry"]],
  ],
  [ // Biology
    [["war", "biology", ["Cell", "Diseases Nutrients & Vitamins"]]],
    [["war", "biology", ["Diseases Nutrients & Vitamins", "Nutrition & Digestion"]]],
    [["war", "biology", ["Circulatory & Excretory System", "Nervous System & Sense Organs"]]],
    [["war", "biology", ["Plant & Animal Kingdom", "Heredity Evolution & Miscellaneous"]]],
    [["war", "biology", ["Plant Growth Hormones", "Tissues"]]],
  ],
  [ // Static GK — Culture, Sports, Books
    [["war", "static-gk", ["SPORTS", "BOOKS AND AUTHORS"]]],
    [["war", "static-gk", ["DANCES", "MUSICAL INSTRUMENTS & GHARANAS"]]],
    [["war", "static-gk", ["FESTIVALS AND FAIRS", "TEMPLES & MONUMENTS"]]],
    [["war", "static-gk", ["IMPORTANT DAYS AND GOVT SCHEMES", "MISLINEOUS"]]],
    [["war", "static-gk", ["SPORTS", "BOOKS AND AUTHORS"]]],
  ],
  [ // Static GK — Awards, Orgs, Days
    [["war", "static-gk", ["AWARDS & HONOURS", "INT & NATIONAL ORG"]]],
    [["war", "static-gk", ["INT & NATIONAL ORG", "IMPORTANT DAYS AND GOVT SCHEMES"]]],
    [["war", "static-gk", ["AWARDS & HONOURS", "MISLINEOUS"]]],
    [["war", "static-gk", ["INT & NATIONAL ORG", "TEMPLES & MONUMENTS"]]],
    [["war", "static-gk", ["AWARDS & HONOURS", "SCIENCE & TECH"]]],
  ],
];
function gaUnit(i) {
  const u = GA_ROT[i % 14];
  const p = Math.floor(i / 14) % u.passes.length; // 7-din ka pass — har pass agle chapters
  const [c1, c2] = u.passes[p];
  return {
    name: u.name,
    topics: c1.label + " + " + c2.label, // block text mein dikhta hai — aaj ke 2 chapters
    links: [c1, c2, u.pyq],
    auto: GA_PASS_AUTO[i % 14][p % GA_PASS_AUTO[i % 14].length], // usi din ke chapters ke questions
  };
}
...
// Ek hi page — Mistake Notebook ab Answers ke andar hi hai (src dropdown).
const MISTAKES = [L("/answers?subject=all&src=pyq", "Galat questions")];
...
function planFor(n) {
  ...
  if (n === 1) {
    ...
    blocks.push(
      ...
      B("GA", "GS inventory + pehla topic", "Polity se shuru — ULTA order: pehle ▶ 15 Q (FR ke hi questions aayenge), phir notes mein sirf woh dekho jo galat/blank gaya.", 60, [nt("polity", "Fundamental Rights", "Polity notes"), L("/pyq/gk/polity", "Polity PYQ")], A([["war", "polity", ["Fundamental Rights", "Salient Features"]]], 15)),
    ...
    blocks.push(
      ...
      B("QA", Q1.name + " — 25 Q", "LADDER: pehle 5 Q solution KE SAATH (Show answer -> padho -> dhak ke khud karo). Phir 20 khud se, 90-sec rule: nahi bana -> Show answer -> agla. Atakna BAN hai, solution dekhna nahi.", 60, Q1.links.slice(1), A(Q1.auto, 25)),
      B("QA", Q2.name + " — 25 Q", "Same ladder: 5 solution ke saath, phir 20 khud se (90-sec rule). Short method only — long se sahi bhi galat aadat hai.", 60, Q2.links.slice(1), A(Q2.auto, 25))
    );
    if (n >= 5) blocks.push(
      ...
      B("QA", "Calculation speed", "Calculation drill — 10 min tables/squares/percentages + aaj ke types ke 20 aur sawal.", 60, [Q1.links[1]], A([...Q1.auto, ...Q2.auto], 20))
    );
    blocks.push(
      B("GA", ga1.name, "AAJ SIRF 2 CHAPTERS: " + ga1.topics + ". GS ke Q FLASHCARDS hain, test nahi: 20-30 sec/Q max — nahi aata to TURANT Show answer, explanation padho, agla. Galat hona hi kaam hai. Phir notes mein SIRF galat waale points (2-3 min/page scan). 10 min: galat points Notebook mein.", 60, ga1.links, A(ga1.auto, 15)),
      B("GA", ga2.name, "AAJ SIRF 2 CHAPTERS: " + ga2.topics + ". Same flashcard style: 20-30 sec/Q, answer dekho, aage. Score pehle pass pe matter nahi karta — teesre pass pe karega.", 60, ga2.links, A(ga2.auto, 15)),
      B("GA", "Current Affairs", "Roz ka 30 min — Daily CA + WAR CA PYQ.", 30, CA_LINKS, CA_AUTO),
      B("GA", "Kal ka recall test", "Kal ke chapters (" + gaPair(n - 1)[0].topics + " · " + gaPair(n - 1)[1].topics + ") ke 20 sawal — 15+ sahi target.", 30, [war("static-gk", "WAR"), L("/pyq/gktricks", "GKTricks")], A([...gaPair(n - 1)[0].auto, ...gaPair(n - 1)[1].auto], 20)),
    ...
    blocks.push(
      ...
      B("GA", ga1.name, "AAJ KE 2 CHAPTERS: " + ga1.topics + ". Recall-first — aur mock ke GS mein jo blank gaya, use pehle. Phir 15 Q.", 60, ga1.links, A(ga1.auto, 15)),
      ...
      B("REV", "Warning list update", "Mistake Notebook kholo aur apni repeat galtiyon par ek pass maaro — mock ne jo naya sikhaya.", 30, MISTAKES)
    );
  } else if (n <= 24) {
    phase = "Build";
    ...
    blocks.push(
      ...
      B("QA", "Calculation — 15 min", "Roz ka calc drill — yeh QA ki speed ka engine hai.", 15, []),
      B("GA", ga1.name, "AAJ KE 2 CHAPTERS: " + ga1.topics + ". Round 2 hai — pehle ▶ 15 Q, phir notes sirf galat waale ke liye. Pichli baar se kam galat honge — wahi progress hai.", 60, ga1.links, A(ga1.auto, 15)),
      B("GA", ga2.name, "AAJ KE 2 CHAPTERS: " + ga2.topics + ". Same ulta order: Q pehle, notes baad mein.", 60, ga2.links, A(ga2.auto, 15)),
    ...
    blocks.push(
      ...
      B("QA", "Mixed timed", "20 mixed Q, 13 min. Skip ka faisla 10 sec mein — yeh bhi drill se aata hai.", 45, [m25("simplification-and-approximation", "Mixed")], AM(20)),
    ...
    blocks.push(
      ...
      B("GA", "Revision marathon", "Static GK notes + apni sheets ka revision. Recall-first. Beech mein 20 Q self-test.", 120, [L("/notes/static-gk", "Static GK")], A(GS_MIX, 20)),
    ...
    if (n === 35 || n === 37) {
      blocks.push(
        ...
        B("QA", "Formulas + 50 mixed Q", "Brahmastra full pass + 50 mixed questions timed sets mein — '▶ Q shuru' se 25-25 ke do set.", 150, [L("/notes/brahmastra", "Brahmastra"), m25("simplification-and-approximation", "Mixed")], AM(25)),
        ...
        B("REV", "Warning list — final", "Mistake Notebook ka final pass: REPEAT galtiyon ki 'exam-day warning list' banao (max 10 points).", 60, MISTAKES)
      );
    } else if (n === 39) {
      blocks.push(
        B("GA", "GS sheets — 120 min", "Sirf apni sheets aur notes ke highlighted hisse. Naya kuch nahi.", 120, [L("/notes/static-gk", "Static GK")]),
  ...
  // CORE marking — din ke 5-6 non-negotiable blocks. Sirf yeh ho gaye to din
  // COUNT hota hai; baaki bonus. Overwhelm ("15 blocks, kuch nahi ho para") ka
  // ilaaj: choice chhota karo. Core = output-work only (questions), reading nahi.
  let cQA = 0, cGA = 0, cEN = 0, cREV = 0;
  for (const b of blocks) {
    if (isMock && b.sec === "MOCK") { b.core = true; continue; }
    if (b.sec === "QA" && b.auto && cQA < 2) { b.core = true; cQA++; }
    else if (b.sec === "GA" && b.auto && cGA < 2) { b.core = true; cGA++; }
    else if (b.sec === "EN" && cEN < 1 && (b.auto || /vocab/i.test(b.t))) { b.core = true; cEN++; }
    else if (b.sec === "REV" && cREV < 1) { b.core = true; cREV++; }
  }
