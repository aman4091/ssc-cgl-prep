...
function planFor(n) {
  ...
  if (n === 1) {
    ...
    blocks.push(
      B("GA", ga1.name, "AAJ SIRF 2 CHAPTERS: " + ga1.topics + ". ORDER ULTA: (1) PEHLE ▶ 15 Q — bina padhe, galat hone do. (2) Notes mein SIRF galat/blank waala dekho — page 2-3 min scan (naam, number, article), prose nahi. (3) 10 min: galat points Notebook mein. Ratta NAHI — yeh area 4 baar aur aayega.", 60, ga1.links, A(ga1.auto, 15)),
      B("GA", ga2.name, "AAJ SIRF 2 CHAPTERS: " + ga2.topics + ". Same ulta order: pehle Q, phir targeted notes. GS recognition ka game hai, recall ka nahi.", 60, ga2.links, A(ga2.auto, 15)),
