...
const GA_ROT = [
  ...
  { name: "Physics", links: [nt("parmar-physics", "Motion", "Parmar"), nt("parmar-physics", "Electricity", "Electricity"), war("physics", "113 PYQ")] },
  ...
  { name: "Biology", links: [nt("parmar-biology", "Cell", "Parmar"), nt("parmar-biology", "Diseases", "Diseases"), war("biology", "114 PYQ")] },
  { name: "Static GK — Culture, Sports, Books", links: [nt("parmar-static", "Sports", "Parmar"), nt("parmar-static", "Books and Authors", "Books"), war("static-gk")] },
  { name: "Static GK — Awards, Orgs, Days", links: [nt("parmar-static", "Awards and Honours", "Parmar"), nt("parmar-static", "International Organisations", "Orgs"), war("static-gk")] },
];
const GA_AUTO = [
  [["gk", "polity"]],
