...
function planFor(n) {
  ...
  if (n === 1) {
    ...
    blocks.push(
      B("GA", ga1.name, "AAJ SIRF 2 CHAPTERS: " + ga1.topics + " — poora area nahi. Recall-first: pehle khud se points likho, phir notes se milao. Phir 15 Q.", 60, ga1.links, A(ga1.auto, 15)),
      B("GA", ga2.name, "AAJ SIRF 2 CHAPTERS: " + ga2.topics + ". Same tareeka — GS mein padhna nahi, YAAD karna hai.", 60, ga2.links, A(ga2.auto, 15)),
    ...
    blocks.push(
      ...
      B("GA", ga1.name, "AAJ KE 2 CHAPTERS: " + ga1.topics + ". Is baar speed se: 45 min recall-revision, phir 15 Q self-test.", 60, ga1.links, A(ga1.auto, 15)),
      B("GA", ga2.name, "AAJ KE 2 CHAPTERS: " + ga2.topics + ". Same style.", 60, ga2.links, A(ga2.auto, 15)),
