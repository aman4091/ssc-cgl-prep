...
const GA_ROT = [
  { name: "Polity — Constitution, FR, DPSP", links: [nt("polity", "Fundamental Rights", "SIMPLICRACK"), nt("parmar-polity", "Salient Features of the Constitution", "Parmar"), L("/pyq/gk/polity", "1077 PYQ")] },
  { name: "Polity — Parliament, President, Courts", links: [nt("polity", "The Parliament", "SIMPLICRACK"), nt("parmar-polity", "Supreme Court and High Court", "Parmar"), war("polity")] },
  { name: "History — Ancient", links: [nt("parmar-history", "Jainism and Buddhism", "Parmar"), nt("history", "Gupta Empire", "Handwritten"), L("/pyq/gk/ancient-history", "600 PYQ")] },
  { name: "History — Medieval", links: [nt("parmar-history", "Delhi Sultanate", "Parmar"), nt("history", "Mughal Sultanate", "Handwritten"), war("mediaeval-history")] },
  { name: "History — Modern", links: [nt("parmar-history", "Gandhian Era", "Parmar"), nt("history", "Modern History (1919-1937)", "Handwritten"), war("modern-history")] },
  { name: "Geography — India", links: [nt("parmar-geography", "Himalayan River System", "Rivers"), nt("parmar-geography", "Agriculture", "Agriculture"), war("geography")] },
  { name: "Geography — World + Environment", links: [nt("parmar-geography", "Solar System", "Solar system"), nt("parmar-geography", "World Map", "World map"), war("environment")] },
  { name: "Economy — Basics, Banking", links: [nt("parmar-economy", "Basics of Economy", "Parmar"), nt("parmar-economy", "Banking: Part 1", "Banking"), war("economics")] },
  { name: "Economy — Budget, Plans, Reports", links: [nt("parmar-economy", "Budget and Taxation", "Budget"), nt("parmar-economy", "Five Year Plan and Industrial Policy", "5-yr plans"), war("economics")] },
  { name: "Physics", links: [war("physics", "113 PYQ"), nt("static-gk", "Fundamental Units", "Units")] },
  { name: "Chemistry + Science misc", links: [war("chemistry", "PYQ"), nt("static-gk", "Important Chemical Names & Formula", "Formulas"), nt("static-gk", "The Branches of Science", "Branches")] },
  { name: "Biology", links: [war("biology", "114 PYQ"), nt("static-gk", "Diseases Occurring in Human Body", "Diseases")] },
  { name: "Static GK — Culture, Sports, Books", links: [nt("static-gk", "Games & Sports", "Sports"), nt("static-gk", "Important Books & Their Authors", "Books"), war("static-gk")] },
  { name: "Static GK — Awards, Orgs, Days", links: [nt("static-gk", "Important National & International Awards", "Awards"), nt("static-gk", "Famous International Organisations and their Headquarters", "Orgs"), war("static-gk")] },
];
function gaPair(n) { const i = (n - 1) * 2; return [GA_ROT[i % 14], GA_ROT[(i + 1) % 14]]; }
...
function B(sec, t, task, min, links) { return { sec, t, task, min, links: links || [] }; }
...
function planFor(n) {
  ...
  if (n === 1) {
    ...
    blocks.push(
      ...
      B("QA", "2 rusty types — 15-15 Q", "Unhi dono ke 15-15 questions Pinnacle Maths se. Har sawal pe socho: iska chhota tareeka kya tha?", 90, [m("percentage"), m("algebra")]),
      B("QA", "Baseline sectional", "Quiz Bank se ek RBE Sectional — Maths set do (fullscreen test mode mein). Jo score aaye — baseline hai, judgement nahi. Marks entry karo.", 45, DRILL.QA),
      B("GA", "GS inventory + pehla topic", "Polity se shuru: Fundamental Rights ka recall-first revision — pehle khud yaad karo, phir notes se milao.", 60, [nt("polity", "Fundamental Rights", "Polity notes"), L("/pyq/gk/polity", "Polity PYQ")]),
      B("GA", "Current Affairs", "Aaj se roz 30 min CA — Daily CA + WAR ke CA PYQ. Bina naagha.", 30, CA_LINKS),
      B("EN", "Vocab Day shuru", "Vocab system mein aaj ka day kholo — 50 words. Roz ka fix slot hai yeh.", 30, vocabLinks(n)),
      B("EN", "Error-spotting diagnostic", "Pinnacle Spot-the-Error ke 25 sawal. Note karo kaunse RULES pakad mein nahi — wahi aage ka focus.", 45, [pin("spot-the-error")]),
      ...
      B("GI", "Reasoning baseline", "RBE Sectional — Reasoning ka ek set. Tum yahan already strong ho (35-44) — bas confirm karo.", 45, DRILL.GI),
    ...
    blocks.push(
      ...
      B("QA", Q1.name + " — 25 Q", "25 questions, SHORT method se — long method se sahi hua to bhi galat aadat hai. Jo 90 sec mein na bane, chhodo aur solution ka method dekho.", 60, Q1.links.slice(1)),
      B("QA", Q2.name + " — 25 Q", "25 questions, short method only. Target 60 sec/Q.", 60, Q2.links.slice(1))
    );
    if (n >= 5) blocks.push(
      B("QA", "Speed sectional", "RBE Sectional — Maths ka set, fullscreen test mode, time pressure ke saath. Baad mein 10 min: har slow sawal ka short method.", 45, DRILL.QA),
      B("QA", "Mixed 15 Q", "Ab tak ke covered types mila ke 15 questions — type pehchanna bhi skill hai.", 15, [m25("simplification-and-approximation", "Mixed")])
    );
    else blocks.push(
      B("QA", "Calculation speed", "Calculation drill — 10 min tables/squares/percentages + aaj ke types ke 20 aur sawal.", 60, [L("/calculation", "Calc drill"), Q1.links[1]])
    );
    blocks.push(
      B("GA", ga1.name, "Recall-first revision: pehle khud se points likho, phir notes se milao. Jo yaad nahi tha — highlight.", 60, ga1.links),
      B("GA", ga2.name, "Doosra topic, same tareeka. GS mein padhna nahi — YAAD karna hai.", 60, ga2.links),
      B("GA", "Current Affairs", "Roz ka 30 min — Daily CA + WAR CA PYQ.", 30, CA_LINKS),
      B("GA", "Kal ka recall test", "Kal ke dono GS topics ke PYQ karo (WAR/GKTricks se) — 20 sawal, 15+ sahi target.", 30, [war("static-gk", "WAR"), L("/pyq/gktricks", "GKTricks")]),
      B("EN", "Vocab — aaj ka day", "50 words + kal ke words ka revision.", 30, vocabLinks(n)),
      B("EN", "Grammar: " + en.name, "Rules padho, phir practice. Rules ki chhoti sheet banate jao — Notebook mein.", 45, en.links),
      B("EN", "2 RC passages", "Timed: 8-8 min. Questions pehle, passage baad mein.", 30, [pin("comprehension", "RC")]),
      B("EN", "Cloze + mixed PYQ", "1 cloze set + 20 mixed English PYQ.", 45, [pin("cloze-test", "Cloze"), pin("fill-in-the-blanks", "Fill blanks")]),
      B("GI", gi.name, "20-25 questions — 36 sec/Q target. Reasoning maintenance hai, naya seekhna nahi.", 45, gi.links),
      B("GI", n % 2 === 0 ? "Sectional drill" : "Mixed practice", n % 2 === 0 ? "RBE Sectional — Reasoning set + review. Puzzle/seating pe atakna mana — 10 sec mein skip ka faisla." : "Mixed reasoning — 20 Q speed se.", 45, n % 2 === 0 ? DRILL.GI : [rs("mathematical-operation", "Mixed")]),
    ...
    blocks.push(
      ...
      B("QA", "Weak type — 25 Q", "Mock mein Maths ka jo type sabse zyada khaya, usi ke 25 questions.", 60, [Q1.links[1] || Q1.links[0]]),
      B("QA", "Speed sectional", "RBE Sectional — Maths + 10 min review.", 45, DRILL.QA),
      B("QA", "DI — 2 sets", "Roz ka DI. 1 set = 3-4 pakke marks.", 30, QA_UNITS.di.links),
      B("GA", ga1.name, "Recall-first revision — mock ke GS mein jo areas blank gaye, wahi pehle.", 60, ga1.links),
      B("GA", "Current Affairs", "Roz ka 30 min.", 30, CA_LINKS),
      B("EN", "Vocab — aaj ka day", "Roz ka fix slot.", 30, vocabLinks(n)),
      B("EN", "RC + cloze", "2 RC + 1 cloze, timed.", 45, [pin("comprehension", "RC"), pin("cloze-test", "Cloze")]),
      B("GI", "Light drill", "Reasoning ka ek section set — bas haath garam.", 30, DRILL.GI),
    ...
    blocks.push(
      B("QA", "Speed sectional", "RBE Sectional — Maths, fullscreen, 15-min pressure. Target: 16+ attempts, 75%+ accuracy. 10 min review.", 45, DRILL.QA),
      B("QA", "DI — 2 sets", "Roz ka DI block. 3.5 min/set target.", 30, QA_UNITS.di.links),
      B("QA", Q1.name + " — round 2", "25 Q time pressure ke saath: 45 sec/Q. " + Q1.tip, 60, Q1.links.slice(1)),
      B("QA", Q2.name + " — round 2", "25 Q, 45 sec/Q. " + Q2.tip, 60, Q2.links.slice(1)),
      B("QA", "Calculation — 15 min", "Roz ka calc drill — yeh QA ki speed ka engine hai.", 15, [L("/calculation", "Calc drill")]),
      B("GA", ga1.name, "Round 2 — is baar speed se: 45 min content, 15 min self-test PYQ se.", 60, ga1.links),
      B("GA", ga2.name, "Doosra topic, same style.", 60, ga2.links),
      B("GA", "Current Affairs", "30 min + purane CA notes ka 10 min revision.", 30, CA_LINKS),
      B("GA", "Sectional GK", "RBE Sectional — GK ka set. GS mein jo aata hai turant, jo nahi aata guess+move.", 30, DRILL.GA),
      B("EN", "Vocab — aaj ka day", "Naye 50 + purane ka revision.", 30, vocabLinks(n)),
      B("EN", "Grammar revision: " + en.name, "Rules sheet dekho + 20 questions. Ab naya nahi — pakka karna hai.", 30, en.links),
      B("EN", "2 RC + 1 cloze", "RC ab 7 min/passage target.", 45, [pin("comprehension", "RC"), pin("cloze-test", "Cloze")]),
      B("EN", "Sectional English", "RBE Sectional — English. 15 min mein poore 25 yahin sabse pehle honge — pehli jeet.", 45, DRILL.EN),
      B("GI", gi.name, "20 Q + 10 mixed. 36 sec/Q.", 45, gi.links),
    ...
    blocks.push(
      B("QA", "Speed sectional", "RBE Sectional — Maths + review. Target: 16+ attempts, 75%+ accuracy.", 45, DRILL.QA),
      B("QA", "Error-repair — 90 min", "Mistake Notebook kholo. Maths ke 3 sabse repeat-hone-wale types — har ek ke 20-20 Q unke chapters se. Galti wahi hai jo dohraayi jaye.", 90, MISTAKES),
      B("QA", "DI — 2 sets", "Roz ka DI.", 30, QA_UNITS.di.links),
      B("QA", "Mixed timed", "20 mixed Q, 13 min. Skip ka faisla 10 sec mein — yeh bhi drill se aata hai.", 45, [m25("simplification-and-approximation", "Mixed"), L("/calculation", "Calc")]),
      B("GA", "Weak topic 1", "Recall-test ke hisaab se GS ka sabse kamzor topic — full revision + PYQ.", 60, [L("/notes/static-gk", "Static notes"), L("/pyq/gktricks", "GK PYQ")]),
      B("GA", "Weak topic 2", "Doosra kamzor topic.", 60, [nt("parmar-polity", "Noteworthy Points", "Parmar"), war("static-gk")]),
      B("GA", "Sectional GK + CA", "RBE Sectional — GK + roz ka CA.", 60, [...DRILL.GA.slice(0, 1), ...CA_LINKS.slice(0, 1)]),
      B("EN", "Sectional English", "Section set + review.", 30, DRILL.EN),
      B("EN", "Vocab + weak grammar", "30 min vocab + jo rule mocks mein sabse zyada kaat raha hai.", 45, [L("/vocab", "Vocab"), L("/english/pocket", "Pocket Rules")]),
      B("EN", "RC + cloze", "2 RC + 1 cloze timed.", 45, [pin("comprehension", "RC"), pin("cloze-test", "Cloze")]),
      B("GI", "Sectional + weak topic", "Reasoning set + jo type mocks mein galat ja raha uske 20 Q.", 60, [...DRILL.GI.slice(0, 1), rs("puzzle", "Puzzle"), rs("sitting-arrangement", "Seating")]),
    ...
    blocks.push(
      ...
      B("GA", "Revision marathon", "Static GK notes + apne Notebook sheets ka revision. Recall-first.", 120, [L("/notes/static-gk", "Static GK"), L("/notebook", "Notebook")]),
      B("QA", "Formula sheets + 30 Q", "Brahmastra ka full pass + 30 easy-medium Q sirf confidence ke liye.", 60, [L("/notes/brahmastra", "Brahmastra"), m25("simplification-and-approximation", "Easy Q")]),
      ...
      B("GI", "Light drill", "Ek section set — haath garam.", 30, DRILL.GI)
    );
  } else if (n >= 35) {
    phase = "Taper";
    why = n >= 39
    ...
    if (n === 35 || n === 37) {
      blocks.push(
        B("GA", "GS marathon — 150 min", "Structured revision: Polity → History → Geo → Science → Economy → Static. Notes books se, recall-first.", 150, [L("/notes/polity", "Polity"), L("/notes/parmar-geography", "Geography"), L("/notes/static-gk", "Static GK")]),
        B("QA", "Formulas + 50 mixed Q", "Brahmastra full pass + 50 mixed questions timed sets mein.", 150, [L("/notes/brahmastra", "Brahmastra"), m25("simplification-and-approximation", "Mixed"), L("/calculation", "Calc")]),
        B("EN", "Vocab + rules revision", "Poori vocab list + Pocket Rules + apni sheets.", 90, [L("/vocab/bookmarks", "Saved words"), L("/english/pocket", "Pocket Rules")]),
        B("GI", "Light drill", "Ek section set + review.", 60, DRILL.GI),
      ...
      blocks.push(
        ...
        B("GI", "1 halka set", "Bas rhythm ke liye. Aaj jaldi sona — neend bhi tayari hai.", 30, DRILL.GI)
      );
    } else {
      blocks.push(
