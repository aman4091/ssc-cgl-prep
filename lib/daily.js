...
export const DEFAULT_TARGETS = {
  ...
  // Aadatein — PYQ ke question nahi, par roz na karo to sab bhool jata hai.
  vocab: 60, ca: 20,
};
...
export const SUBJECT_ORDER = ["reasoning", "english", "gs", "math", "vocab", "ca"];
...
export function lockedSubjects(plan) {
  ...
  // Sirf PYQ wale subject band hote hain. Vocab aur CA aadatein hain — unhe
  // rokne se koi faayda nahi, wo to kabhi bhi ho sakti hain.
  return new Set(["english", "gs", "math"]);
}
