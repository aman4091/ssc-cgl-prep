...
export function paintBar(theme) {
  try {
    ...
    // Kaale roop (lib/look.js) mein patti hamesha kaali — din/raat se farak nahi.
    const look = document.documentElement.getAttribute("data-look");
    m.setAttribute("content", LOOK_BAR[look] || (theme === "dark" ? BAR.dark : BAR.light));
