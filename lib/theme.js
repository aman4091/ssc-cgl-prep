...
// Timeline ke parde ka rang (app/looks/timeline.css ka --tb-navy).
const TIMELINE_BAR = "#0d1122";
...
export function paintBar(theme) {
  try {
    ...
    // Site ka roop Timeline hai — raat ka neela. Uski patti hamesha wahi
    // rang hai, din/raat se farak nahi padta.
    m.setAttribute("content", TIMELINE_BAR);
