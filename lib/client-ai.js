...
export function sprintAnswer({ question, options, correct, subject }) {
  return post("/api/sprint-answer", { question, options, correct, subject: baseSubject(subject) }); // -> { answer }
}
