...
function blank() {
  return { items: {}, history: [], window: DEFAULT_WINDOW, cap: HARD_CAP, budget: DEFAULT_BUDGET };
}
function read() {
...
export function getConfig() { const st = read(); return { window: st.window, cap: st.cap, budget: st.budget }; }
