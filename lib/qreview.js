...
export function addReview(q, opts = {}) {
  ...
  write(all);
  // Galat answer -> English/GS ka item apne-aap weak-pool (20x revision) mein.
  // enrollWrong khud Maths/Reasoning ko chhod deta (wo Speed-bucket ka kaam).
  if (!correct) { try { enrollWrong(q, { subject, category: rec.category }); } catch { /* srs off */ } }
}
