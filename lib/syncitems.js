...
export const LOCAL_ONLY = new Set([
  ...
  "cgl.home.active",
  // Din/raat bhi is DEVICE ka maamla hai. Tablet raat mein bistar par chalti
  // hai aur laptop din mein mez par — ek jagah dark karke doosri jagah dark
  // kar dena madad nahi, dakhal hai.
  "cgl.theme",
  // 🚨 Panic: list R2 ki copy hai (har device khud le aata hai), aur shuffle
  // ki thaili is device ki apni hai. Press ka log (cgl.panic.log) sync hota hai.
  "cgl.panic.list",
  "cgl.panic.bag",
  // "Aakhri baar notes ke kis page par ✨ dabaya" — ye is device ki nazar
  // hai, data nahi. Doosre device par uska koi matlab nahi.
  "cgl.pastednotes.last",
]);
